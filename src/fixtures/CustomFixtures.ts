...
// .extend: This is a built-in function that says: "Keep everything the original runner can do, but add these extra capabilities on top of it."

// 3. <CustomFixtures> (The Generics)
